    ...
    return (
        <div onMouseEnter={handleHover} onMouseLeave={handleHoverExit} className="overflow-hidden">
            ...
            <div className="relative h-1 w-full">
                <div
                    className={cn(
                        "absolute left-0 -top-1 h-[3px] w-full bg-neutral-300 transition-transform duration-300",
                        isHoveredIn
                ...
                <div
                    className={cn(
                        "absolute left-0 -top-1 h-[3px] w-full translate-x-0 transform bg-neutral-300 opacity-0 transition-transform duration-300",
